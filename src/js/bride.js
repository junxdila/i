...
export const bride = () => {
    ...
    const brideListItem = (data) => (
        `<li data-aos="zoom-in" data-aos-duration="1000">
              ...
              <p><img src="./src/assets/images/instagram.png" alt="alternatetext" width="10" height="10">${data.ig}<br><br>${data.child}<br>dari<br>Bapak ${data.father} & Ibu ${data.mother}</p>
